...
def run_multi_timeseries():
    SeriesFileParameters = open('SeriesParameters.csv','a')
    SeriesFileErrors = open('SeriesErrors.csv','a')
    SeriesFileResults = open('SeriesResults.csv','a')
    ...
    active_params = ["V_tot", "E_max", "C_ao", "R_sys", "C_sv", "E_min", "Z_ao", "R_mv"]
    noise = 0.3
    x0 = np.array([250.0, 2.0, 1.0, 1.0, 10.0, 0.06, 0.1, 0.003])
    x_scale = [500.0, 2.0, 2.0, 2.0, 10.0, 0.05, 0.1, 0.005]
    bounds = [2000.0, 5.0, 10.0, 3.0, 30.0, 1.0, 1.0, 0.1]
    bounds_low = [50.0, 0.9, 0.5, 0.5, 0.5, 0.0, 0.0, 0.0]
